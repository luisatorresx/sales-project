...
class ProductoForm(forms.Form):
    ...
    iva = forms.IntegerField(widget=forms.NumberInput(attrs={"'value': '16', class": "textInput", "min":"0", "step":"1","onkeydown":"if(event.key==='.'){event.preventDefault();}","autocomplete":"off", "onCopy":"return false", "onDrag":"return false", "onDrop":"return false", "onPaste":"return false", "placeholder": "IVA"}))
