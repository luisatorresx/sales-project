...
class FacturaForm(forms.Form):
    ...
    cedula = forms.IntegerField(widget=forms.NumberInput(attrs={"class": "textInput", "min":"1", "step":"1","style":"width: 65%;","onkeydown":"if(event.key==='.'||event.keyCode == 13){event.preventDefault();}","autocomplete":"off", "onCopy":"return false", "onDrag":"return false", "onDrop":"return false", "onPaste":"return false"}))
